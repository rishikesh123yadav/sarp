<%@ Page Language="C#" AutoEventWireup="true" CodeFile="co.aspx.cs" Inherits="co" %>
...
<div class="user">
    ...
    <asp:Button ID="logout" Width="120px" class="cc" runat="server" Text="Logout" 
            onclick="logout_Click1" UseSubmitBehavior="False" ValidationGroup="tt"/>
    </div>
    </div>
    <table align="center">
 ...
 <asp:ScriptManager ID ="ScriptMannager1" runat ="server"></asp:ScriptManager>
  ...
  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
         DataKeyNames="sid" align="center" Width="550px" DataSourceID="SqlDataSource2" 
         AutoGenerateDeleteButton="True" ForeColor="White" 
         style="text-align: center">
         <Columns>
             <asp:BoundField DataField="name" HeaderText="Student Name" 
                 SortExpression="name" />
             <asp:BoundField DataField="sid" HeaderText="Studenrt ID" ReadOnly="True" 
                 SortExpression="sid" />
         </Columns>
     </asp:GridView>
     ...
     <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
         ...
         SelectCommand="select manager.name,co.sid from manager,co  where manager.sid = co.sid" DeleteCommand="DELETE from [co] where[sid]=@sid">
     </asp:SqlDataSource>
