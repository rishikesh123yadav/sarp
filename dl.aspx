<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dl.aspx.cs" Inherits="dl" %>
 ...
 <hr />
  ...
  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
     ...
     <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
         ...
         SelectCommand="select manager.name, dl.sid from manager,dl where manager.sid=dl.sid" DeleteCommand="DELETE from [dl] where[sid]=@sid">
     </asp:SqlDataSource>
